  ...
  return (
    ...
    {/* <div className="min-h-screen  text-white p-4 flex justify-center">
      <div className="w-full max-w-md space-y-5">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-2xl border border-gray-700 shadow">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-5 rounded-2xl border border-gray-700 shadow text-center">
          <p className="text-gray-400 text-sm mb-1">Total Amount Earned</p>
          <h2 className="text-3xl font-bold">Rs. 3500</h2>
        </div>

     
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-2xl border border-gray-700 text-center">
            <p className="text-gray-400 text-sm">Pending For Withdrawal</p>
            <h3 className="text-xl font-bold mt-1">Rs. 200</h3>
          </div>

          <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-2xl border border-gray-700 text-center">
            <p className="text-gray-400 text-sm">Training Completed By</p>
            <h3 className="text-xl font-bold mt-1">06</h3>
          </div>

          <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-2xl border border-gray-700 text-center">
            <p className="text-gray-400 text-sm">Total Users Referred</p>
            <h3 className="text-xl font-bold mt-1">08</h3>
          </div>

          <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-2xl border border-gray-700 text-center flex flex-col justify-center">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-400 p-5 rounded-2xl shadow-lg">
          <h2 className="text-xl font-bold mb-2">Withdrawal ↗</h2>
          <p className="text-sm text-blue-100">
            Withdrawal the amount you have earned directly to your bank account
            through UPI.
          </p>
        </div>
      </div>
